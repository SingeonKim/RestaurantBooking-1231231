...
class BookingSchedulerTest(unittest.TestCase):
    ...
    @patch.object(BookingScheduler, 'get_now', return_value=datetime.strptime(SUNDAY_DATE, "%Y/%m/%d %H:%M"))
    ...
    @patch.object(BookingScheduler, 'get_now', return_value=datetime.strptime(MONDAY_DATE, "%Y/%m/%d %H:%M"))
