...
CUSTOMER = Customer("Fake name", "010-123405678")
...
class BookingSchedulerTest(unittest.TestCase):
    ...
    def setUp(self):
        self.testableMailSender = TestableMailSender()
        ...
        self.booking_scheduler.set_mail_sender(self.testableMailSender)
    ...
    def test_이메일이_없는_경우에는_이메일_미발송(self):
        ...
        self.assertEqual(self.testableMailSender.get__count_send_mail_is_called(), 0)
    ...
    def test_이메일이_있는_경우에는_이메일_발송(self):
        ...
        self.assertEqual(self.testableMailSender.get__count_send_mail_is_called(), 1)
